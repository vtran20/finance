...
import com.easysoft.finance.browser.SimpleUrlBrowser;
...
import com.tdameritrade.TDAmeritradeUtil;
...
@RestController
@RequestMapping("/api/td/v1/")
public class TDAmeritradeAPIsController {
    //TODO: Implement Valid by using javax.validation.* for each body data


    private Logger log = LoggerFactory.getLogger(TDAmeritradeAPIsController.class);
    @Autowired
    ...
    @GetMapping("/callback")
    public Map tdAmeritradeCallback(@RequestParam(required = false, name = "code") String code) {
        ...
        map.add("code", code);
        map.add("client_id", TDAmeritradeUtil.getAPIKey());
        map.add("redirect_uri", "https://localhost/api/td/v1/callback");
        ...
        TDAmeritradeUtil.TD_AMERITRADE_API_ACCESS_TOKEN = (String) responseEntity.getBody().get("access_token");
        return null;
    }

    @GetMapping("/authenticate")
    public Map tdAmeritradeAuth(@RequestParam(required = true, name = "symbols") String symbols) {
        String url = "https://auth.tdameritrade.com/auth?response_type=code&redirect_uri=https%3A%2F%2Flocalhost%2Fapi%2Ftd%2Fv1%2Fcallback&client_id=WKSETQUMDUZQGLHDYZHGRIG1L7JJ1WCB%40AMER.OAUTHAP";
//        loginPage.Navigate("https://auth.tdameritrade.com/auth?response_type=code&redirect_uri=https%3A%2F%2Flocalhost%2Fapi%2Ftd%2Fv1%2Fcallback&client_id=WKSETQUMDUZQGLHDYZHGRIG1L7JJ1WCB%40AMER.OAUTHAP");
//        loginPage.Login("78170271", "TranQuang2007");
//        loginPage.clickLogin();

        //Applications/Google Chrome.app
        //browse(url);
        SimpleUrlBrowser browser = new SimpleUrlBrowser();
        browser.browse(url);
    ...
    @GetMapping("/options/er")
    public Map checkingER(@RequestParam(required = true, name = "symbols") String symbols) {
        return TDAmeritradeUtil.getExpectedMovingFromStraddleFromSymbols(symbols);
    }
